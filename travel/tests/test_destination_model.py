...
class DestinationAPITestCase(APITestCase):
    ...
    def test_delete_destination_with_basic_user(self):
            url = reverse(
                "travel:destination-detail",
                kwargs={"pk": self.destination.pk},
            )
    ...
    def test_delete_destination_with_staff_user(self):
            url = reverse(
                "travel:destination-detail",
                kwargs={"pk": self.destination.pk},
            )
    ...
    def test_delete_destination_with_user_not_authenticated(self):
            url = reverse(
                "travel:destination-detail",
                kwargs={"pk": self.destination.pk},
            )
